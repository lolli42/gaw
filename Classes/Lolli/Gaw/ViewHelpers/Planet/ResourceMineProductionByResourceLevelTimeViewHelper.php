...
/**
 * Micro units production of mine by mine level and time
 */
class ResourceMineProductionByResourceLevelTimeViewHelper extends AbstractViewHelper {
	...
	public function render($resource, $level, $time) {
		$time = (int)$time;
		$level = (int)$level;
		return $this->planetCalculationService->resourceMineProductionByTimeAndMineLevel($resource, $time, $level);
	}
}
